...
import pandas as pd
from app_pkg.utils import (load_cues, extract_tasks, score_routine, score_ai_replaceability,
...
st.caption("Dependency-parse verb–object extraction (spaCy) + SSG key task matching.")

with st.sidebar:
    st.subheader("Hints (optional)")
